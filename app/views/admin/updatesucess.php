...
<div class="card">
  ...
  <div class="card-body">
          <form role="form" action="<?=PATH;?>admin/postupdatesucess" method="post" enctype="multipart/form-data">
                  ...
                  <div class="form-group">
                    ...
                    <div class="input-group">
                      <div class="custom-file">
                        <input value="<?= $data->date; ?>" name="pic" type="file" class="custom-file-input" id="exampleInputFile">
