...
<div class="card">
  ...
  <div class="card-body">
          <form role="form" action="<?=PATH;?>admin/postaddnews" method="post" enctype="multipart/form-data">
                  ...
                  <div class="row">
                    <div class="col-sm-6">
                      <div class="form-group">
                        <label>Title</label>
                        <input name="title"type="text" class="form-control" placeholder="Enter News Title">
                      </div>
                    </div>
                  </div>
